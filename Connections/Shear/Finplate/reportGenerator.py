...
#Digram
    ...
    row = [0, '<object type="image/PNG" data="3D_Model.png" width= "150"></object>', '<object type="image/svg+xml" data="finTop.svg" width= "600"></object>']
    rstr += t('tr')
    rstr += t('td  align="center" class=" viewtbl"') + space(row[0]) + row[1] + t('/td')
    rstr += t('td  align="center" class=" viewtbl"') + row[2] + t('/td')
    rstr += t('/tr')
     
    row = [0, '<object type="image/svg+xml"" data="finSide.svg" width= "550"></object>', '<object type="image/svg+xml" data="finFront.svg"></object>']
